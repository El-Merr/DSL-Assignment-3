...
public class MetamodelPackageImpl extends EPackageImpl implements MetamodelPackage {
	 ...
	 * @see nl.tue.dsldesign.robot.metamodel.MetamodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getStep_Direction() {
	 ...
	 * @generated
	 */
	public EAttribute getInitial_XPos() {
	 ...
	 * @generated
	 */
	public EAttribute getInitial_YPos() {
	...
	public void createPackageContents() {
		...
		createEAttribute(stepEClass, STEP__DIRECTION);
		createEAttribute(stepEClass, STEP__DISTANCE);

		initialEClass = createEClass(INITIAL);
		createEAttribute(initialEClass, INITIAL__XPOS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getStep_Distance(), ecorePackage.getEInt(), "distance", "1", 0, 1, Step.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
