...
/**
 * This is the item provider adapter for a {@link nl.tue.dsldesign.robot.metamodel.Robot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RobotItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamodelPackage.Literals.ROBOT__STEPS);
			childrenFeatures.add(MetamodelPackage.Literals.ROBOT__INITIAL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(MetamodelPackage.Literals.ROBOT__STEPS, MetamodelFactory.eINSTANCE.createStep()));

		newChildDescriptors.add(createChildParameter(MetamodelPackage.Literals.ROBOT__INITIAL,
				MetamodelFactory.eINSTANCE.createInitial()));
	}
